...
const EventsCalendar = () => {
  ...
  const details = info => {
    ...
    setFocEvent({
      ...
      Time:
        info.event.start.toDateString().substring(4,10) +
        ": " +
  ...
  useEffect(() => {
    if (window.innerWidth > 966) setShow("none")
  }, [Show])
    ...
    <>
      <ED style={{ left: Pos[0], top: Pos[1], display: Show }}>
        ...
        <svg
          ...
          style={
            window.innerWidth > 966 ? { display: "none" } : { display: "block" }
          }
          width="655"
          height="655"
          viewBox="0 0 655 655"
        ...
        >
          <path
            d="M12.2841 638.781C-3.33688 623.16 -3.33688 597.833 12.2841 582.212L582.212 12.2844C597.833 -3.33659 623.16 -3.33657 638.781 12.2844L643.023 16.527C658.644 32.148 658.644 57.4746 643.023 73.0956L73.0953 643.024C57.4743 658.645 32.1477 658.645 16.5267 643.024L12.2841 638.781Z"
            fill="#4A4A4A"
          />
          <path
            d="M16.5268 12.2843C32.1477 -3.33664 57.4743 -3.33664 73.0953 12.2843L643.023 582.212C658.644 597.833 658.644 623.16 643.023 638.781L638.781 643.024C623.16 658.645 597.833 658.645 582.212 643.024L12.2841 73.0955C-3.33686 57.4745 -3.33684 32.1479 12.2841 16.527L16.5268 12.2843Z"
            fill="#4A4A4A"
          />
        </svg>
      </ED>
